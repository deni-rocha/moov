...
const FormTipoDespesa = (): JSX.Element => {
...
// import { initialState, reducerFormTipoDespesa } from './reducerFormEdit'
...
//         <p class="preview-data-key">Despesa</p>
...
//       </li>
//       <li class="preview-data-li">
//         <p class="preview-data-key">arquivo</p>
